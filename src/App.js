...
//Ma function qui me permet de faire la pagination à l'aide du limit et offset//
  handleClick=(e)=>{
    this.setState({
  ...
  render() {
   //Boucle map qui me permet de afficher plusieurs characters ainsi de recupérer les info de l'api//
    ...
    // Ma boucle for qui me permet de diviser le nb total des characteres et ma limit que je souhaite affiché//
    var buttonList = [];
