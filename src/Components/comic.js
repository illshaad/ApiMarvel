...
class Comic extends Component {
  constructor(props){
    super(props)
    //par defaut le modal et fermer //
    this.state = {
      modal: false,
    }
  }
  //function qui me permet de ouvrir le modal//
  ModalVisible =()=>{
    console.log('Openmodal')
    this.setState({modal :true})
  }
//function qui me permet de fermer le modal//
  ModalInvisible =()=>{
...
//Mise en place du Card et le Modal avec reactstrap //
    return (
      ...
      <div style={{marginBottom:50}}>
        ...
        <ModalHeader style={{backgroundColor:"whitesmoke"}} ModalVisible={this.ModalVisible}>{this.props.comicsTitle}</ModalHeader>
